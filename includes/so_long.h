...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/25 20:29:03 by sehattor          #+#    #+#             */
/*   Updated: 2022/06/25 20:29:04 by sehattor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				draw_img(t_so_long *sl, t_img *img, t_ipair p,
						bool is_ignore);
...
void				bfs_utils(t_so_long *sl, int **map, t_list **lst,
						int *item_sum);
